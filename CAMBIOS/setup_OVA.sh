...
# Instalamos gdb para depurar código
echo -e "${GREEN}Instalando gdb...${NC}"
sudo apt install -y gdb
echo -e "${GREEN}gdb instalado correctamente.${NC}"
...
# Configuración de permisos sudoers para gdb
echo "www-data ALL=(ALL) NOPASSWD: /usr/bin/gdb" | sudo tee -a /etc/sudoers > /dev/null
echo -e "${GREEN}Permiso especial para gdb configurado.${NC}"
