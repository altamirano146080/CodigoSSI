...
if ($resultado && mysqli_num_rows($resultado) > 0) {
    ...
    if ($contraseña == $fila['contrasena']) {
        ...
        if ($es_administrador && ($fila2['usuario_id'] && $fila['id']) == 1) {
            ...
            echo '<script>
            document.getElementById("error_message").innerHTML = "El cuy3 usuario o la contraseña son incorrectos";
        ...
        echo '<script>
        document.getElementById("error_message").innerHTML = "El cuy2 usuario o la contraseña son incorrectos";
        document.getElementById("error_message").style.display = "block";
      </script>';
